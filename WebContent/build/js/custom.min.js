...
function system_netifinfo_callback(response){
  ...
  var strs = colStrs.split("$$$"); // 7

  $("#netifinfo").html(response.slice(0, 40) + "</br>" + response.slice(40));
}
...
if(!window.location.href.includes("index3.html")){
  $(document).ready(function() {
    clearInterval(interval_interface_id5), clearInterval(interval_interface_id6);
  });
}
