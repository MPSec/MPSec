/* junhee code */
var globalLineChart1;
var globalLineChart2;
var globalLineChart3;
var globalLineChart4;
var globalLineChart5; //gre
var globalLineChart6; //gre
var globalInterfaceName1; var interval_interface_id1;
var globalInterfaceName2; var interval_interface_id2;
var globalInterfaceName3; var interval_interface_id3;
var globalInterfaceName4; var interval_interface_id4;
var globalInterfaceName5; var interval_interface_id5; //gre
var globalInterfaceName6; var interval_interface_id6; //gre
var system_cpuload_id; var system_cpusage_id;
var system_date_id; var system_hostip_id;
var system_hostname_id; var system_memusage_id;
var system_netifinfo_id; var system_sessioncount_id;  var system_taskcount_id;
var chartData1 = 0; var greToggle1 = 0; greToggle2 = 0;  //gre

var interval_capture_id;
var defaultInterface = "enp0s3";
...
function eraseUnUse(response){
  response = replaceAll(response, "<html>", "");
  response = replaceAll(response, "</html>", "");
...
function addTwoData(chart, label, data1, data2) {
    if (chart.data.datasets[0].data.length > 15) {
        chart.options.animation.duration = 0;
        chart.data.labels.shift(); // remove the label first
        chart.data.datasets.forEach(function(dataset, datasetIndex) {
...
function httpGetAsyncMainInterface(theUrl, callback)
{
    var xmlHttp = new XMLHttpRequest();
    xmlHttp.onreadystatechange = function() {
        if (xmlHttp.readyState == 4 && xmlHttp.status == 200){
    ...
    xmlHttp.open("GET", theUrl + "?interfaceName=" + globalInterfaceName1, true); // true for asynchronous
    xmlHttp.send(null);
}
function httpGetAsyncGre1(theUrl, callback)
{
    var xmlHttp = new XMLHttpRequest();
    xmlHttp.onreadystatechange = function() {
        if (xmlHttp.readyState == 4 && xmlHttp.status == 200){
...
function httpGetAsyncGre2(theUrl, callback)
{
    var xmlHttp = new XMLHttpRequest();
    xmlHttp.onreadystatechange = function() {
        if (xmlHttp.readyState == 4 && xmlHttp.status == 200){
...
function httpGetAsyncGre3(theUrl, callback)
{
    var xmlHttp = new XMLHttpRequest();
    xmlHttp.onreadystatechange = function() {
        if (xmlHttp.readyState == 4 && xmlHttp.status == 200){
...
function system_cpuload_callback(response){
  var num = parseInt(response);
  cpusage_DoughnutChart.data.datasets[0].data=[num,100-num];
  cpusage_DoughnutChart.update();
  $("#cpuload").html(num);
}
function system_cpusage_callback(response){
  var num = parseInt(response);
  cpusage_DoughnutChart.data.datasets[0].data=[num,100-num];
  cpusage_DoughnutChart.update();
  $("#cpusage").html(num);
}
function system_date_callback(response){
  $("#date").html(response);
}
function system_hostip_callback(response){
  $("#hostip").html(response);
}
function system_hostname_callback(response){
  $("#hostname").html(response);
}
function system_memusage_callback(response){
  var num = parseInt(response);
  memusage_DoughnutChart.data.datasets[0].data=[num,100-num];
  memusage_DoughnutChart.update();
  $("#memusage").html(num);
}
function system_netifinfo_callback(response){
   response = eraseUnUse(response);
   var colStrs = response.split("***"); // 4
   for(var i=0; i<colStrs.length-1; i++)
   {
     var strs = colStrs[i].split("@@@"); // 7
     $("#ifindex" + i).html(strs[0]);
     $("#ifname" + i).html(strs[1]);
     $("#hwaddr" + i).html(strs[2]);
     $("#inetaddr" + i).html(strs[3]);
     $("#linkspeed" + i).html(strs[4]);
     $("#oeprstate" + i).html(strs[5]);
   }



}
function system_sessioncount_callback(response){
  $("#sessioncount").html(response);
}
function system_taskcount_callback(response){
...
function myCallBack2(response){
  response = eraseUnUse(response);
	var date = new Date();
	var present_time = date.getHours() + ":" + date.getMinutes() + ":" + date.getSeconds();
	addData(globalLineChart1, present_time , response);
	$("#BW1").html(response);
}
function myCallBack3(response){
  ...
  var date = new Date();
	var present_time = date.getHours() + ":" + date.getMinutes() + ":" + date.getSeconds();
	addData(globalLineChart2, present_time , response);
	$("#BW2").html(response);
}
function myCallBack4(response){
  response = eraseUnUse(response);
	var date = new Date();
	var present_time = date.getHours() + ":" + date.getMinutes() + ":" + date.getSeconds();
	addData(globalLineChart3, present_time , response);
	$("#BW3").html(response);
}
function myCallBack5(response){
  response = eraseUnUse(response);
	var date = new Date();
	var present_time = date.getHours() + ":" + date.getMinutes() + ":" + date.getSeconds();
	addData(globalLineChart4, present_time , response);
	$("#BW4").html(response);
}
function myCallBack6(response){ //gre
  response = eraseUnUse(response);
	var date = new Date();
	var present_time = date.getHours() + ":" + date.getMinutes() + ":" + date.getSeconds();
  if(greToggle1 == 1){
  	addTwoData(globalLineChart5, present_time , chartData1, response);
    $("#BW5").html(response);
  }
  if(greToggle2 == 1){
  	addTwoData(globalLineChart6, present_time , chartData1, response);
    $("#BW6").html(response);
  }

}
function myCallBack7(response){ //gre
  response = eraseUnUse(response);
	var date = new Date();
	var present_time = date.getHours() + ":" + date.getMinutes() + ":" + date.getSeconds();
	addTwoData(globalLineChart6, present_time , chartData1, response);
...
function myCallBackIpSecStart(response){
  response = eraseUnUse(response);
  $("#ipsecColor1").css("background-color","lightgray");
  $("#ipsecColor2").css("background-color","lightgray");
  $("#ipsecColor3").css("background-color","lightgray");
  $("#ipsecColor4").css("background-color","lightgray");
  $("#ipsecColor5").css("background-color","lightgray");
  alert(response);
}
function myCallBackIpSecStop(response){
  response = eraseUnUse(response);
  $("#ipsecColor1").css("background-color","white");
  $("#ipsecColor2").css("background-color","white");
  $("#ipsecColor3").css("background-color","#f5f5dc");
  $("#ipsecColor4").css("background-color","white");
  $("#ipsecColor5").css("background-color","white");
  alert(response);
}
function init_video_source(response){
  response = eraseUnUse(response);
  httpGetAsync('./jsp/get_ifname2.jsp?interfaceName=' + response, init_host_interface_name);
  var video = document.getElementById('my_client_video');
  video.setAttribute('src', 'http://' + response + ':12390/test1.webm');
  video.play();
}
function init_video_source1(response){ //gre
  response = eraseUnUse(response);
  httpGetAsync('./jsp/get_ifname2.jsp?interfaceName=' + response, init_host_interface_name);
...
function init_video_source2(response){ //gre
  response = eraseUnUse(response);
  httpGetAsync('./jsp/get_ifname2.jsp?interfaceName=' + response, init_host_interface_name);
...
function my_capture1(response){
  response = eraseUnUse(response);
  var strs = response.split("@@@ET30984ET30985@@@");
  $("#snapping_hader1").html(strs[0]);
  for(var i=0; i<strs[1].length; i++){
    if(i!=0 && i%50 ==0){
      strs[1] = insert(strs[1], i, "<br/>");
    }
  }
  for(var j=0; j<strs[2].length; j++){
    if(j!=0 && j%30 ==0){
      strs[2] = insert(strs[2], j, "<br/>");
    }
  }
  $("#snapping_binary1").html(strs[1]);
  $("#snapping_utf1").html(strs[2]);
}
function my_capture2(response){
  response = eraseUnUse(response);
  var strs = response.split("@@@ET30984ET30985@@@");
  $("#snapping_hader2").html(strs[0]);
  for(var i=0; i<strs[1].length; i++){
    if(i!=0 && i%50 ==0){
      strs[1] = insert(strs[1], i, "<br/>");
    }
  ...
  $("#snapping_binary2").html(strs[1]);
  $("#snapping_utf2").html(strs[2]);
}
function capturing1(){
  interval_capture_id1 = setInterval(function() { httpGetAsync('./jsp/capture.jsp', my_capture1); }, 1000);
}
function capturing2(){
  interval_capture_id2 = setInterval(function() { httpGetAsync('./jsp/capture.jsp', my_capture2); }, 1000)
}
function my_clear1(){
  clearInterval(interval_capture_id1);
  $("#snapping_hader1").html("");
  $("#snapping_binary1").html("");
  $("#snapping_utf1").html("");
}
function my_clear2(){
  clearInterval(interval_capture_id2);
  $("#snapping_hader2").html("");
  $("#snapping_binary2").html("");
  $("#snapping_utf2").html("");
}
function init_host_interface_name(response){
  response = eraseUnUse(response);
  defaultInterface = response;
}
function init_interface_name1(response){
  response = eraseUnUse(response);
  globalInterfaceName1 = response;
  if(globalInterfaceName1 == ""){
    globalInterfaceName1 = defaultInterface;
  }
  $("#interfaceName1").html(globalInterfaceName1 + ", tx+rx");

  $("#if-down1").attr('onclick', '');
  $("#if-down1").unbind('click');
  $("#if-down1").bind('click', function () { httpGetAsync('./jsp/ifdown.jsp?interfaceName='  + globalInterfaceName1 , myCallBack); });

  $("#if-up1").attr('onclick', '');
  $("#if-up1").unbind('click');
  $("#if-up1").bind('click', function () { httpGetAsync('./jsp/ifup.jsp?interfaceName='  + globalInterfaceName1 , myCallBack); });
}
function init_interface_name2(response){
  response = eraseUnUse(response);
  globalInterfaceName2 = response;
  if(globalInterfaceName2 == ""){
    globalInterfaceName2 = defaultInterface;
  }
  $("#interfaceName2").html(globalInterfaceName2 + ", tx+rx");

  $("#if-down2").attr('onclick', '');
  $("#if-down2").unbind('click');
  $("#if-down2").bind('click', function () { httpGetAsync('./jsp/ifdown.jsp?interfaceName='  + globalInterfaceName2 , myCallBack); });

  $("#if-up2").attr('onclick', '');
  $("#if-up2").unbind('click');
  $("#if-up2").bind('click', function () { httpGetAsync('./jsp/ifup.jsp?interfaceName='  + globalInterfaceName2 , myCallBack); });
}
function init_interface_name3(response){
  response = eraseUnUse(response);
  globalInterfaceName3 = response;
  if(globalInterfaceName3 == ""){
    globalInterfaceName3 = defaultInterface;
  }
  $("#interfaceName3").html(globalInterfaceName3 + ", tx+rx");

  $("#if-down3").attr('onclick', '');
  $("#if-down3").unbind('click');
  $("#if-down3").bind('click', function () { httpGetAsync('./jsp/ifdown.jsp?interfaceName='  + globalInterfaceName3 , myCallBack); });

  $("#if-up3").attr('onclick', '');
  $("#if-up3").unbind('click');
  $("#if-up3").bind('click', function () { httpGetAsync('./jsp/ifup.jsp?interfaceName='  + globalInterfaceName3 , myCallBack); });
}
function init_interface_name4(response){
  response = eraseUnUse(response);
  globalInterfaceName4 = response;
  if(globalInterfaceName4 == ""){
    globalInterfaceName4 = defaultInterface;
  }
  $("#interfaceName4").html(globalInterfaceName4 + ", tx+rx");

  $("#if-down4").attr('onclick', '');
  $("#if-down4").unbind('click');
  $("#if-down4").bind('click', function () { httpGetAsync('./jsp/ifdown.jsp?interfaceName='  + globalInterfaceName4 , myCallBack); });

  $("#if-up4").attr('onclick', '');
  $("#if-up4").unbind('click');
  $("#if-up4").bind('click', function () { httpGetAsync('./jsp/ifup.jsp?interfaceName='  + globalInterfaceName4 , myCallBack); });
}
function init_interface_name5(response){ //gre
  response = eraseUnUse(response);
  response = replaceAll(response, "@" + globalInterfaceName1, "");
  globalInterfaceName5 = response;
  if(globalInterfaceName5 == ""){
    globalInterfaceName5 = defaultInterface;
  }
  $("#interfaceName5").html(globalInterfaceName1 + " = green" + "<br/><h2>" + globalInterfaceName5 + " = red</h2>");
  $("#interfaceName6").html(globalInterfaceName1 + " = green" + "<br/><h2>" + globalInterfaceName5 + " = red</h2>");
}
function init_interface_name6(response){ //gre  tunnel2 이름 알아낼 수 있음, 근데 안씀
  response = eraseUnUse(response);
  response = replaceAll(response, "@" + globalInterfaceName1, "");
  globalInterfaceName6 = response;
  if(globalInterfaceName6 == ""){
    globalInterfaceName6 = defaultInterface;
  }
}
...
function init_charts() {
    if (console.log("run_charts  typeof [" + typeof Chart + "]"), "undefined" != typeof Chart) {
        ...
        if ($("#lineChart3").length) {
            var f = document.getElementById("lineChart3");
            globalLineChart3 = new Chart(f, {
                type: "line",
                data: {
                    labels: ["first"],
                    datasets: [{
        ...
        if ($("#lineChart4").length) {
            var f = document.getElementById("lineChart4");
            globalLineChart4 = new Chart(f, {
                type: "line",
                data: {
                    labels: ["first"],
                    datasets: [{
        ...
        if ($("#lineChart5").length) { //gre
            var f = document.getElementById("lineChart5");
            globalLineChart5 = new Chart(f, {
                type: "line",
                data: {
                    labels: ["first"],
                    datasets: [{
                    ...
                    {
                        label: "My Second dataset",
                    backgroundColor: "rgba(103, 3, 3, 0.3)",
                        borderColor: "rgba(103, 3, 3, 0.70)",
                        pointBorderColor: "rgba(103, 3, 3, 0.70)",
                        pointBackgroundColor: "rgba(103, 3, 3, 0.70)",
                        pointHoverBackgroundColor: "#fff",
                        pointHoverBorderColor: "rgba(103,187,205,1)",
                        pointBorderWidth: 1,
                        data: [0]
                    }]
                },
        ...
        if ($("#lineChart6").length) {//gre
            var f = document.getElementById("lineChart6");
            globalLineChart6 = new Chart(f, {
                type: "line",
                data: {
                    labels: ["first"],
                    datasets: [{
...
$.fn.popover.Constructor.prototype.leave = function(a) {
 ...
 /* junhee code */
$(document).ready(function() {
  httpGetAsync('./jsp/get_hostip.jsp', init_video_source), httpGetAsync('./jsp/get_ifname2.jsp?interfaceName=192.168.10.1', init_interface_name1)
  , httpGetAsync('./jsp/get_ifname2.jsp?interfaceName=192.168.20.1', init_interface_name2), httpGetAsync('./jsp/get_ifname2.jsp?interfaceName=192.168.30.1', init_interface_name3)
  , httpGetAsync('./jsp/get_ifname2.jsp?interfaceName=192.168.40.1', init_interface_name4);
});
if(window.location.href.includes("index.html")){
  $(document).ready(function() {
    ...
    interval_interface_id1 = setInterval(function() {
        httpGetAsync('./jsp/bw1.jsp?interfaceName=' + globalInterfaceName1 , myCallBack2);
    }, 1000),
    interval_interface_id2 = setInterval(function() {
        httpGetAsync('./jsp/bw1.jsp?interfaceName=' + globalInterfaceName2, myCallBack3);
    }, 1000),
    interval_interface_id3 = setInterval(function() {
        httpGetAsync('./jsp/bw1.jsp?interfaceName=' + globalInterfaceName3, myCallBack4);
    }, 1000),
    interval_interface_id4 = setInterval(function() {
        httpGetAsync('./jsp/bw1.jsp?interfaceName=' + globalInterfaceName4, myCallBack5);
    }, 1000);
 });
}
if(!window.location.href.includes("index.html")){
  $(document).ready(function() {
    clearInterval(interval_interface_id1), clearInterval(interval_interface_id2), clearInterval(interval_interface_id3), clearInterval(interval_interface_id4);
  });
}
if(window.location.href.includes("index3.html")){
 $(document).ready(function() {
    httpGetAsync('./jsp/get_hostip.jsp', init_video_source1), httpGetAsync('./jsp/get_hostip.jsp', init_video_source2),
    httpGetAsync('./jsp/get_ifname2.jsp?interfaceName=192.168.10.1', init_interface_name1),
    httpGetAsync('./jsp/get_ifname2.jsp?interfaceName=192.168.100.1', init_interface_name5),
    httpGetAsync('./jsp/get_ifname2.jsp?interfaceName=192.168.200.1', init_interface_name6),
    interval_interface_id5 = setInterval(function() {
       httpGetAsync('./jsp/bw1.jsp?interfaceName=' + globalInterfaceName5 , myCallBack6);
    }, 1000),
    interval_interface_id1 = setInterval(function() {
       httpGetAsync('./jsp/bw1.jsp?interfaceName=' + globalInterfaceName1 , myCallBack8);
    }, 1000);
 });
}
if(!window.location.href.includes("index3.html")){
  $(document).ready(function() {
    clearInterval(interval_interface_id5),
    clearInterval(interval_interface_id6);
  });
}
...
if(window.location.href.includes("index4.html")){
 $(document).ready(function() {
   system_cpuload_id = setInterval(function() { httpGetAsync('./jsp/system/cpuload.jsp', system_cpuload_callback); }, 1000),
   system_cpusage_id = setInterval(function() { httpGetAsync('./jsp/system/cpusage.jsp', system_cpusage_callback); }, 1000),
   system_date_id = setInterval(function() { httpGetAsync('./jsp/system/date.jsp', system_date_callback); }, 1000),
   system_hostip_id = setInterval(function() { httpGetAsync('./jsp/system/hostip.jsp', system_hostip_callback); }, 1000),
   system_hostname_id = setInterval(function() { httpGetAsync('./jsp/system/hostname.jsp', system_hostname_callback); }, 1000),
   system_memusage_id = setInterval(function() { httpGetAsync('./jsp/system/memusage.jsp', system_memusage_callback); }, 1000),
   system_netifinfo_id = setInterval(function() { httpGetAsync('./jsp/system/netifinfo.jsp', system_netifinfo_callback); }, 1000),
   system_sessioncount_id = setInterval(function() { httpGetAsync('./jsp/system/sessioncount.jsp', system_sessioncount_callback); }, 1000),
   system_taskcount_id = setInterval(function() { httpGetAsync('./jsp/system/taskcount.jsp', system_taskcount_callback); }, 1000);
 });
}
if(!window.location.href.includes("index4.html")){
  $(document).ready(function() {
    clearInterval(system_cpuload_id),
    clearInterval(system_cpusage_id),
    clearInterval(system_date_id),
    clearInterval(system_hostip_id),
    clearInterval(system_hostname_id),
    clearInterval(system_memusage_id),
    clearInterval(system_netifinfo_id),
    clearInterval(system_sessioncount_id),
    clearInterval(system_taskcount_id);
  });
}
